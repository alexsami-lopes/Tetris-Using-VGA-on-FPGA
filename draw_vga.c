...
void gen_barrel (int part, int *x1, int *y1, int *x2, int *y2, unsigned *color) {
    ...
    int barrel_width = 100;  // Ajuste a largura do barril
    int barrel_height = 200; // Ajuste a altura do barril
    ...
    *color = barrel_color[0]; // Define a cor do barril como branco
    ...
    if (part == 0) {
        ...
        *x1 = center_x - barrel_width;
        *y1 = base_y - 10;
        *x2 = center_x + barrel_width;
        *y2 = base_y;
    }
    else if (part == 1) {
        // Parte esquerda do barril
        *x1 = center_x - barrel_width;
        *y1 = base_y - barrel_height;
        *x2 = center_x - barrel_width + 10;
        *y2 = base_y - 10;
    }
    else if (part == 2) {
        // Parte direita do barril
        *x1 = center_x + barrel_width - 10;
        *y1 = base_y - barrel_height;
        *x2 = center_x + barrel_width;
        *y2 = base_y - 10;
    }
